  ...
  return (
    ...
    >
      <radialGradient
        ...
        cx="0"
        cy="0"
        gradientTransform="matrix(-29 -189 126 -19 196.43117835159384 514.3017586220893)"
      ...
      <radialGradient
        ...
        cx="0"
        cy="0"
        gradientTransform="matrix(50 -379 280 37 397.56882164840613 259.23788965349286)"
        gradientUnits="userSpaceOnUse"
        r="1"
      >
        <stop offset="0" stopColor="#fff" stopOpacity=".6"></stop>
      ...
      <radialGradient
        ...
        cx="0"
        cy="0"
        gradientTransform="matrix(-56 -288 149 -29 122.5963503077686 218.77753792907498)"
        gradientUnits="userSpaceOnUse"
        r="1"
      >
        <stop offset="0" stopColor="#fff" stopOpacity=".8"></stop>
        <stop offset="1" stopColor="#fff" stopOpacity=".4"></stop>
      </radialGradient>
      <radialGradient
        id="logo-bottom-right"
        cx="0"
        cy="0"
        gradientTransform="matrix(-77 -157 180 -89 420.91741402191263 588.3017586220893)"
        gradientUnits="userSpaceOnUse"
        r="1"
      >
        <stop offset="0" stopColor="#fff" stopOpacity=".3"></stop>
        <stop offset="1" stopOpacity=".3"></stop>
      </radialGradient>
      <radialGradient
        id="logo-top-edge"
        cx="0"
      ...
      >
        <stop offset="0" stopColor="#fff" stopOpacity=".2"></stop>
        <stop offset=".5" stopColor="#fff" stopOpacity=".2"></stop>
        <stop offset="1" stopColor="#fff" stopOpacity=".3"></stop>
      </radialGradient>
      <clipPath id="clip">
